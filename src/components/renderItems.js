// class RenderItems extends HTMLElement {
//   constructor() {
//     super();
...
class HobbyCardList extends HTMLElement {
  constructor() {
      super();
  ...
  renderItems(data) {
      ...
      const todosOsCards = data.map((item) => {
          return `
          <head><link rel="stylesheet" href="cards.css"></head>
              <li itemscope itemtype="http://schema.org/HobbyShop" class="containerLi">
  ...
  connectedCallback() {
      const data = [
          ...
          },
          {
            ...
            this.shadowRoot.appendChild(this.renderItems(data));
  }
}

customElements.define('hobby-card-list', HobbyCardList);